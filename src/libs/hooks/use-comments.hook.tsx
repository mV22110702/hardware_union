...
export const useComments = ()=>{
    ...
    const handleCommentContentChange: ChangeEventHandler<HTMLInputElement|HTMLTextAreaElement> =
        useCallback(
            (event) => {
    ...
    return {commentContent,comments,handleCommentSubmit,handleCommentContentChange};
};